- Ingest the 4 attached files and make sure you have read everything to the letter and follow all the instructions to the letter.
...
- Now review the next subsection, optimize it and rewrite it. Follow the protocols and instructions from the system-prompt-protocols.md file and make sure the documentation is very concise.
