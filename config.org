...
#+RESULTS:
| eldoc-mouse-mode | #[nil ((add-hook 'eldoc-documentation-functions #'ar/generic-eldoc-backend 0 t)) nil] | #[nil ((add-hook 'eldoc-documentation-functions #'ar/paren-eldoc-offscreen-context -50 t)) (t)] | #[nil ((add-hook 'eldoc-documentation-functions #'ar/generic-eldoc-backend 0 t)) (t)] | eldoc-mode-set-explicitly |
