...
(use-package solaire-mode
  ...
  :custom
  ;; Reduce unnecessary refreshes that cause flicker
  (solaire-mode-refresh-on-buffer-list-change nil)
  (solaire-mode-refresh-on-window-configuration-change nil)
  :config
  ;; Disable solaire-mode in temporary org-src edit buffers
  (add-hook 'org-src-mode-hook (lambda () (solaire-mode -1))))
#+end_src
