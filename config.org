...
** DONE LSP - handle the org-src-context.el file
- State "DONE"       from "TODO"       [2026-01-26 Mon 23:23]
#+begin_src emacs-lisp
  ...
  (transient-define-prefix ar/toggles-devtools ()
    ...
    [:description ar/devtools-title
     ...
     ["Actions"
      ...
      ("h" "Toggle Hints" eglot-inlay-hints-mode :transient t :if (lambda () (fboundp 'eglot-inlay-hints-mode)))
      ("R" "Reconnect LSP" eglot-reconnect)]

     ;; Group 2: Navigation & Lookup
     ["Navigation"
      ("d" "Definition" xref-find-definitions)
      ("D" "References" xref-find-references)
     ...
     ["Diagnostics"
      ("n" "Next Error" ar/flymake-next-error :transient t)
      ("p" "Prev Error" ar/flymake-prev-error :transient t)
      ("e" "Buf Errors" flymake-show-buffer-diagnostics)
      ("E" "Proj Errors" consult-flymake)
      ("!" "Start Check" flymake-start :transient t)]

     ;; Group 5: Code Folding
     ["Folding"
      ("TAB" "Toggle Node" treesit-fold-toggle :transient t)
      ("O" "Open All" treesit-fold-open-all :transient t)
      ("C" "Close All" treesit-fold-close-all :transient t)
      ("v" "Vimish Toggle" vimish-fold-toggle :transient t)]

     ;; Group 6: Documentation
     ["Docs"
      ("k" "Hover Box" eldoc-box-help-at-point :transient t)
      ("K" "Echo Doc" eldoc)
      ("?" "Info Manual" consult-info)
      ("M" "Man Page" woman)
      ("<escape>" "" transient-quit-one :format " ")]]))
#+end_src
...
* DONE LaTeX Writing Environment
