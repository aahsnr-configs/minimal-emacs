...
;;   (org-modern-todo nil)
;;   (org-modern-tag nil)         ; Use your custom tag styling
;;   (org-modern-priority nil)    ; Use your custom priority faces

;;   ;; --- (3) Enabled Features ---
;;   (org-modern-keyword t)           ; Badges for #+TITLE, #+AUTHOR
...
;;   (org-modern-list '((43 . "➤")    ; + becomes Arrow
;;                      (45 . "•")    ; - becomes Dot
;;                      (42 . "•")))  ; * becomes Dot

;;   ;; Org-Modern alignment settings
;;   (setq org-auto-align-tags nil
;;         org-tags-column 0
...
;;   :config
;;   ;; Font adjustments for alignment
;;   (custom-set-faces
;;    '(org-modern-keyword ((t (:inherit font-lock-keyword-face :slant italic :weight bold))))
;;    '(org-modern-label ((t (:height 0.9 :weight medium :family "JetBrains Mono"))))
;;    '(org-modern-symbol ((t (:height 1.0 :family "Symbols Nerd Font Mono"))))))
#+end_src
