...
(use-package org-capture
  ...
  (defun ar/capture-dispatch ()
    "Smart capture: GTD task, Zettelkasten note, fleeting thought, or journal."
    (interactive)
  ...
  (org-capture-templates
   `(;; Quick journal entry (NOT a task)
     ...
     ;; Meeting notes (extract tasks later via ar/zettel-to-gtd)
     ("m" "Meeting" entry
     ...
     ;; Reading/book notes (becomes a literature note via org-roam)
     ...
     ("h" "Habit" entry
      ...
      :empty-lines 1))))
  ;; FIX: Removed the :config block containing
  ;; (remove-hook 'org-capture-prepare-finalize-hook
  ;;              'org-capture-insert-template-here)
  ;; The function org-capture-insert-template-here does not exist in
  ;; standard org-mode. The call was a no-op and has been removed.
#+end_src
