...
(use-package org-super-agenda
  ...
  :config
  ;; FIX: Removed the (:name "🚀 Active Projects (Zettelkasten)"
  ;;                    :and (:tag "project" :file-path "roam/projects")) group.
  ;; Since my/org-roam-directory is intentionally excluded from
  ;; org-agenda-files, :file-path against "roam/projects" will never match —
  ;; that group would be permanently empty and misleading.
