...
(use-package citar-denote
  ...
  :after (citar denote)
  :custom
  ;; Store literature notes in notes/literature/ inside denote-directory.
...
(use-package cape
  ...
  (defun ar/cape-dabbrev-accept-all ()
    "Like `cape-dabbrev' but accepts all inputs (cape README example 5).
Required when `corfu-auto' is t for `corfu-preselect' to auto-insert
the first candidate on popup open."
    (cape-wrap-accept-all #'cape-dabbrev))
  (add-hook 'completion-at-point-functions #'ar/cape-dabbrev-accept-all)
...
* TODO Terminal
*Replace eshell with term from doom emacs modules*
...
;;                  . ,(eglot-alternatives '(("pyrefly" "lsp"))))))
