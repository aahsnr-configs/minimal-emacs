Filename: file-operation-hooks.html
...
<html lang="en">
  <head>
    ...
    <title>Emacs IDE — File-Operation Hooks</title>
    <link
    ...
    <header class="topbar">
      <div class="topbar-left">
        ...
        <div class="crumbs" aria-label="Breadcrumb">
          ...
          <span class="cur" aria-current="page">File-Operation Hooks</span>
        </div>
      </div>
      <button
        class="icon-btn"
      ...
      <header class="page-head">
        ...
        <div class="meta-bar">
          ...
          <div class="meta-item">
            ...
            <code
              >Custom Elisp<span class="route-arrow">→</span
              >eglot--execute-request<span class="route-arrow">→</span
              >eglot--apply-workspace-edit<span class="route-arrow">→</span>OS
              rename-file</code
            >
          </div>
        </div>
                ...
                <div class="vs-card ok">
                  ...
                  <div class="vs-list">
                    ...
                    <div class="vs-row">
                      ...
                      <span class="val"
                        >Explicitly opt-in. Prevents accidental LSP spam when
                    ...
                    <div class="vs-row">
                      ...
                      <span class="val"
                        >Leverages <code>eglot--execute-request</code> and
                ...
                <div class="vs-card no">
                  ...
                  <div class="vs-list">
                    ...
                    <div class="vs-row">
                      <span class="lab">Emacs 31 synergy</span>
                      <span class="val"
                        >Relies on legacy, heavy workspace management
                        abstractions.</span
                      >
                    </div>
                  </div>
...
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Emacs IDE — Execute Command</title>
    <link
      href="https://cdn.jsdelivr.net/npm/@fontsource/jetbrains-mono@5.0.18/index.min.css"
      rel="stylesheet"
    />
    ...
    <header class="topbar">
      <div class="topbar-left">
        ...
        <div class="crumbs" aria-label="Breadcrumb">
          ...
          ><span class="s" aria-hidden="true">/</span>
          <span class="cur" aria-current="page">Execute Command</span>
        </div>
      </div>
      <button
        class="icon-btn"
      ...
      <header class="page-head">
        ...
        <div class="meta-bar">
          ...
          <div class="meta-item">
            <span class="k">Routing</span>
            <code
              >eglot<span class="route-arrow">→</span>eglot-execute-command<span
                class="route-arrow"
                >→</span
              >completing-read (Vertico/Consult)</code
            >
          </div>
        </div>
      </header>
...
(ar/global-leader
  ...
  "c i" '(eglot-code-action-organize-imports :wk "Organize imports (LSP)"))</code></pre>
              </div>
            </div>
          </div>
        </div>
                ...
                <div class="vs-card ok">
                  ...
                  <div class="vs-list">
                    ...
                    <div class="vs-row">
                      ...
                      <span class="val"
                        >Leverages the existing <code>vertico</code> /
                    ...
                    <div class="vs-row">
                      ...
                      <span class="val"
                        ><code>eglot</code> checks server capabilities before
                ...
                <div class="vs-card no">
                  ...
                  <div class="vs-list">
                    ...
                    <div class="vs-row">
                      <span class="lab">UI Physics</span>
                      <span class="val"
                        >Uses heavy, custom child-frame pipelines or bespoke
                        completion UIs.</span
                      >
                    </div>
                    <div class="vs-row">
                      <span class="lab">Safety</span>
                      <span class="val"
                        >Often requires manual filtering or risks executing
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        ...
                        Imports" into <code>textDocument/codeAction</code> (<kbd
                          >SPC c a</kbd
                        >) rather than <code>workspace/executeCommand</code>.
                      </td>
                    </tr>
                  </tbody>
                </table>
