Filename: go-to-type-definition.html
...
<html lang="en">
  <head>
    ...
    <title>Emacs IDE — Go to Type Definition</title>
    <link
    ...
    <header class="topbar">
      <div class="topbar-left">
        ...
        <div class="crumbs" aria-label="Breadcrumb">
          ...
          <span class="cur" aria-current="page">Go to Type Definition</span>
        </div>
      </div>
      <button
        class="icon-btn"
        ...
        <div class="meta-bar">
          ...
          <div class="meta-item">
            ...
            <code
              ...
              >eglot-find-typeDefinition<span class="route-arrow">→</span>xref
              framework</code
            >
          </div>
        </div>
...
(ar/global-leader
  ...
  "c g i" '(eglot-find-implementation :wk "Implementation"))</code></pre>
              </div>
            </div>
          </div>
        </div>
                ...
                <div class="vs-card ok">
                  ...
                  <div class="vs-list">
                    ...
                    <div class="vs-row">
                      ...
                      <span class="val"
                        >Native <code>xref</code> history ring (shared across
                        all backends).</span
                      >
                    </div>
                    <div class="vs-row">
                      ...
                      <span class="val"
                        ><code>eglot</code> gracefully falls back to
...
Filename: go-to-implementation.html
...
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Emacs IDE — Go to Implementation</title>
    <link
      href="https://cdn.jsdelivr.net/npm/@fontsource/jetbrains-mono@5.0.18/index.min.css"
      rel="stylesheet"
    />
    ...
    <header class="topbar">
      <div class="topbar-left">
        ...
        <div class="crumbs" aria-label="Breadcrumb">
          ...
          <span>Navigation &amp; Code Jumping</span
          ><span class="s" aria-hidden="true">/</span>
          <span class="cur" aria-current="page">Go to Implementation</span>
        </div>
      </div>
      <button
        class="icon-btn"
      ...
      <header class="page-head">
        ...
        <div class="parity">
          ...
          <span
            ...
            or abstract definition</span
          >
        </div>
        <div class="meta-bar">
          <div class="meta-item">
            <span class="k">LSP</span>
            <code>textDocument/implementation</code>
          </div>
          <div class="meta-item">
            <span class="k">Routing</span>
            <code
              >eglot<span class="route-arrow">→</span
              >eglot-find-implementation<span class="route-arrow">→</span>xref
              framework</code
            >
          </div>
        </div>
            ...
            <div class="acc-inner">
              ...
              <div class="tbl-wrap">
                <table class="tbl">
                  ...
                  <tbody>
                    <tr>
                      <td>Go to Definition (<kbd>g d</kbd>)</td>
                      <td>The interface or abstract method signature</td>
                      <td><code>interface UserService { ... }</code></td>
                      <td><code>trait UserService { ... }</code></td>
                    </tr>
                    <tr>
                      <td>Go to Implementation (<kbd>g i</kbd>)</td>
                      <td>
                        The concrete class or method fulfilling the contract
                      </td>
                      <td>
                        <code
                      ...
                      <td>
                        <code>impl UserService for DbUserService { ... }</code>
                      </td>
                    </tr>
                  </tbody>
                </table>
              ...
              <div class="tbl-wrap">
                <table class="tbl">
                  ...
                  <tbody>
                    <tr>
                      <td>Right-click → Go to Implementation</td>
                      <td>
                        <kbd>g i</kbd> (<code>eglot-find-implementation</code>)
                        routes via <code>textDocument/implementation</code>.
                      </td>
                    </tr>
                    <tr>
                      <td>Dropdown for multiple implementations</td>
                      <td>
                        <code>consult-xref</code> intercepts the xref display
                        functions for vertico-powered previews.
                      </td>
                    ...
                    <tr>
                      <td>Ctrl+Click on interface name</td>
                      <td>
                        Emacs 31 <code>global-xref-mouse-mode</code>
                        (<kbd>C-&lt;mouse-1&gt;</kbd>).
                      </td>
                    ...
                    <tr>
                      <td>Fallback to definition if impl missing</td>
                      <td>
                        <code>eglot</code> natively falls back to definition if
              ...
              <div class="grid-2">
                ...
                <div class="eco-card">
                  ...
                  <p class="eco-desc">
                    <code>consult-xref</code> intercepts the xref display
                    functions to provide vertico-powered previews for ambiguous
                    implementation targets (e.g., multiple classes implementing
                    an interface).
                  </p>
                </div>
                <div class="eco-card">
                  ...
                  <p class="eco-desc">
                    For non-LSP buffers, <code>treesit</code> modes provide
                    fallback implementation navigation via
                    <code>evil-textobj-tree-sitter</code> text objects combined
                    with <code>imenu</code>.
                  </p>
                </div>
                <div class="eco-card">
                  ...
                  <p class="eco-desc">
                    After jumping to an implementation, the breadcrumb bar
                    immediately reflects the new enclosing class/struct context,
              ...
              <div class="grid-2">
                <div class="stack-card">
                  ...
                  <div class="stack-ct">
                    ...
                    <div class="stack-role">LSP Client</div>
                    <div class="stack-desc">
                      Built-in. Queries <code>textDocument/implementation</code>
                      and injects the location payload into the native
                      <code>xref</code> framework.
                    </div>
                  </div>
                ...
                <div class="stack-card">
                  ...
                  <div class="stack-ct">
                    ...
                    <div class="stack-desc">
                      Emacs 31 NEW. Enables native Ctrl+Click routing for xref
                      payloads, including implementations.
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="acc-inner">
              <div class="tbl-wrap">
                <table class="tbl">
                  ...
                  <tbody>
                    <tr>
                      <td>Jump to implementation</td>
                      <td><code>eglot-find-implementation</code></td>
                      <td><kbd>C-c i</kbd> / <kbd>g i</kbd></td>
                      <td>
                        Jumps to the concrete implementation of the
                    ...
                    <tr>
                      ...
                      <td><kbd>M-.</kbd> / <kbd>g d</kbd></td>
                      <td>
                        Jumps to the interface/abstract definition itself.
                      </td>
                    </tr>
                    <tr>
                      <td>Go back (history)</td>
                    ...
                    <tr>
                      <td>Peek implementation (inline)</td>
                      <td><code>peek-xref-definition</code></td>
                      <td><kbd>SPC c p d</kbd></td>
                      <td>
                        Requires <code>peek</code> package; renders the target
                        inline without switching tabs.
                      </td>
                    </tr>
                  </tbody>
              ...
              <div class="code-win">
                <div class="code-head">
                  <div style="display: flex; align-items: center">
                    ...
                    <span class="fname">init-implementation.el</span>
                  </div>
                  <button
                    class="copy"
                    aria-label="Copy code snippet"
                ...
                <table class="tbl">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td><code>typescript-language-server</code></td>
                      <td>
                        Excellent — accurately finds all classes implementing an
                        interface or overriding an abstract method.
                      </td>
                    </tr>
                    <tr>
                      <td>Java</td>
                      <td><code>jdtls</code></td>
                      <td>
                        Excellent — robustly resolves concrete class
                        implementations and method overrides.
                      </td>
                    </tr>
                    <tr>
                      <td>Rust</td>
                      <td><code>rust-analyzer</code></td>
                      <td>
                        Excellent — precisely locates
                        <code>impl Trait for Type</code> blocks.
                      </td>
                    </tr>
                    <tr>
                      <td>Go</td>
                      <td><code>gopls</code></td>
                      <td>
                        Excellent — finds concrete types that satisfy an
                        interface, even though Go interfaces are implicit.
                      </td>
                    </tr>
                    <tr>
                      <td>C++</td>
                      <td><code>clangd</code></td>
                      <td>
                        Good — finds derived class method overrides, though
                        complex inheritance hierarchies can yield multiple
                        results.
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td><code>pyright</code> / <code>pylsp</code></td>
                      <td>
                        Good — finds subclasses overriding methods, though
                        dynamic typing can limit static resolution accuracy.
                      </td>
                    </tr>
                  </tbody>
                </table>
              ...
              <div class="grid-2">
                ...
                <div class="enh-card p">
                  ...
                  <p class="enh-desc">
                    Emacs 31's <code>xref-change-to-xref-edit-mode</code> (bound
                    to <kbd>e</kbd> in <code>*xref*</code> buffers) turns
                    implementation lists into writable surfaces for bulk
                    mutation.
                  </p>
                </div>
                <div class="enh-card y">
                  <div class="enh-title">consult-xref synergy</div>
                  <p class="enh-desc">
                    Ambiguous implementations (e.g., TypeScript classes
                    implementing a common interface, Rust trait objects) are
                    presented in a highly performant, searchable Vertico
                    dropdown with instant buffer previews.
                  </p>
                </div>
                <div class="enh-card g">
                  <div class="enh-title">Unified xref history</div>
                  <p class="enh-desc">
                    <code>xref-go-back</code> (<kbd>M-,</kbd>) treats
                    implementation jumps identically to definition and reference
                    jumps — the entire navigation chain is preserved in a single
                    ring.
                  </p>
                </div>
              </div>
