...
status: "Working"
parity: "Jump to the concrete class or method that implements an interface or abstract definition"
layout: base.njk
---
...
<div class="parity">
<b>VS Code Parity</b>
<span>Jump to the concrete class or method that implements an interface
...
<code>eglot<span class="route-arrow">→</span>eglot-find-implementation<span class="route-arrow">→</span>xref
              framework</code>
</div>
</div>
</header>
...
<td>
<code>class DbUserService implements UserService { ...
                          }</code>
</td>
<td>
