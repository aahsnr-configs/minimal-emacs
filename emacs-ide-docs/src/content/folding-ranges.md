...
status: "Working"
parity: "Gutter arrows to collapse/expand code blocks, functions, imports, regions"
layout: base.njk
---
...
<div class="parity">
<b>VS Code Parity</b>
<span>Gutter arrows to collapse/expand code blocks, functions, imports,
            regions</span>
</div>
<div class="meta-bar">
<div class="meta-item">
...
<code>treesit-fold<span class="route-arrow">→</span>hideshow<span class="route-arrow">→</span>vimish-fold</code>
</div>
</div>
</header>
...
<td>
<kbd>zc</kbd> / <kbd>zo</kbd> (<code>ar/fold-close</code>
...
(general-define-key
  ...
  "zE" #'vimish-fold-delete-all)</code></pre>{% endraw %}
</div>
</div>
</div>
</div>
...
<span class="val"><b>0ms.</b> Queries the local C-level AST
                        instantly.</span>
</div>
<div class="vs-row">
<span class="lab">Accuracy</span>
<span class="val"><b>Perfect.</b> Tree-sitter understands the exact
...
<span class="val">Custom <code>ar/hs-overlay-line-count</code> appends
...
<div class="vs-row">
<span class="lab">Visual Polish</span>
<span class="val">Generic, uncustomizable server-provided ranges.</span>
</div>
</div>
</div>
</div>
