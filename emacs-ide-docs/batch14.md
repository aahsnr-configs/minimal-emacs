...
<html lang="en">
  <head>
    ...
    <title>Emacs IDE — Document Color</title>
    <link
    ...
    <header class="topbar">
      <div class="topbar-left">
        ...
        <div class="crumbs" aria-label="Breadcrumb">
          ...
          <span class="cur" aria-current="page">Document Color</span>
        </div>
      </div>
      <button
        class="icon-btn"
      ...
      <header class="page-head">
        ...
        <div class="meta-bar">
          ...
          <div class="meta-item">
            ...
            <code
              >colorful-mode<span class="route-arrow">→</span>native
...
(ar/global-leader
  ...
  "t c" '(colorful-mode :wk "Toggle color swatches"))</code></pre>
              </div>
            </div>
          </div>
        </div>
                ...
                <div class="vs-card ok">
                  ...
                  <div class="vs-list">
                    <div class="vs-row">
                      ...
                      <span class="val"
                        >Zero dependency on LSP; works universally across all
                        modes.</span
                      >
                    </div>
                    <div class="vs-row">
                      ...
                      <span class="val"
                        >Honors the <code>eglot</code>-only stack mandate.
                    ...
                    <div class="vs-row">
                      ...
                      <span class="val"
                        ><b>0ms latency.</b> Uses native Emacs regex and overlay
                        stacking.</span
                      >
                    </div>
                    <div class="vs-row">
                      ...
                      <span class="val"
                        >Works offline and is immune to language server crashes
                ...
                <div class="vs-card no">
                  ...
                  <div class="vs-list">
                    ...
                    <div class="vs-row">
                      <span class="lab">Performance</span>
                      <span class="val"
                        ><b>High latency.</b> Queries the language server for
                    ...
                    <div class="vs-row">
                      <span class="lab">Reliability</span>
                      <span class="val"
                        >Fails or degrades if the LSP server does not implement
...
Filename: diagnostics-push.html
...
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Emacs IDE — Diagnostics (Push Model)</title>
    <link
      href="https://cdn.jsdelivr.net/npm/@fontsource/jetbrains-mono@5.0.18/index.min.css"
      rel="stylesheet"
    />
    ...
    <header class="topbar">
      <div class="topbar-left">
        ...
        <div class="crumbs" aria-label="Breadcrumb">
          ...
          ><span class="s" aria-hidden="true">/</span>
          <span class="cur" aria-current="page">Diagnostics (Push)</span>
        </div>
      </div>
      <button
        class="icon-btn"
          ...
          <div class="meta-item">
            ...
            <code
              >eglot<span class="route-arrow">→</span>flymake<span
                class="route-arrow"
                >→</span
              >consult-flymake / native *Flymake diagnostics* buffer</code
            >
          </div>
        </div>
      </header>
                ...
                <div class="vs-card ok">
                  ...
                  <div class="vs-list">
                    ...
                    <div class="vs-row">
                      ...
                      <span class="val"
                        >Leverages new <code>'fancy</code> end-of-line rendering
                ...
                <div class="vs-card no">
                  ...
                  <div class="vs-list">
                    <div class="vs-row">
                      <span class="lab">LSP client coupling</span>
                      <span class="val"
                        ><code>flycheck</code> requires explicit checker
                    ...
                    <div class="vs-row">
                      <span class="lab">Protocol compliance</span>
                      <span class="val"
                        >Adds redundant diagnostic engine overhead or requires
                    ...
                    <div class="vs-row">
                      <span class="lab">Emacs 31 synergy</span>
                      <span class="val"
                        >Lacks integration with Emacs 31 core UI enhancements or
                    ...
                    <div class="vs-row">
                      <span class="lab">Performance</span>
                      <span class="val"
                        >Spawns independent checker processes or incurs
