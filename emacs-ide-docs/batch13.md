...
<html lang="en">
  <head>
    ...
    <title>Emacs IDE — Inline Values (Debugger)</title>
    <link
    ...
    <header class="topbar">
      <div class="topbar-left">
        ...
        <div class="crumbs" aria-label="Breadcrumb">
          ...
          <span>Diagnostics &amp; Debugging</span
          ><span class="s" aria-hidden="true">/</span>
          <span class="cur" aria-current="page">Inline Values</span>
        </div>
      </div>
      <button
        class="icon-btn"
      ...
      <header class="page-head">
        ...
        <div class="meta-bar">
          ...
          <div class="meta-item">
            ...
            <code
              >dape<span class="route-arrow">→</span>dape-inline-variables<span
                class="route-arrow"
                >→</span
              >native buffer overlays</code
            >
          </div>
        </div>
      </header>
...
(ar/global-leader
  ...
  "d d" '(dape :wk "Start debugging"))</code></pre>
              </div>
            </div>
          </div>
        </div>
                ...
                <div class="vs-card ok">
                  ...
                  <div class="vs-list">
                    <div class="vs-row">
                      ...
                      <span class="val"
                        >Minimalist, modern, actively maintained.</span
                      >
                    </div>
                    <div class="vs-row">
                      <span class="lab">Protocol Compliance</span>
                      <span class="val"
                        >Honors the "no <code>dap-mode</code>" constraint while
                    ...
                    <div class="vs-row">
                      ...
                      <span class="val"
                        >Lightweight overlay rendering with minimal main-thread
                        impact.</span
                      >
                    </div>
                    <div class="vs-row">
                      ...
                      <span class="val"
                        >Integrates cleanly with modern Emacs window management
                ...
                <div class="vs-card no">
                  ...
                  <div class="vs-list">
                    <div class="vs-row">
                      <span class="lab">Ecosystem Weight</span>
                      <span class="val"
                        >Heavy, complex, and increasingly deprecated in favor of
                        <code>dape</code>.</span
                      >
                    </div>
                    <div class="vs-row">
                      <span class="lab">Protocol Compliance</span>
                      <span class="val"
                        >Violates the strict architectural constraint against
                    ...
                    <div class="vs-row">
                      <span class="lab">Performance</span>
                      <span class="val"
                        >Known for UI stutter and heavy buffer management during
                        debug sessions.</span
                      >
                    </div>
                    <div class="vs-row">
                      <span class="lab">Emacs 31 Synergy</span>
                      <span class="val"
                        >Legacy architecture with outdated window splitting
                        logic.</span
                      >
                    </div>
                  </div>
...
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Emacs IDE — Document Links</title>
    <link
      href="https://cdn.jsdelivr.net/npm/@fontsource/jetbrains-mono@5.0.18/index.min.css"
      rel="stylesheet"
    />
    ...
    <header class="topbar">
      <div class="topbar-left">
        ...
        <div class="crumbs" aria-label="Breadcrumb">
          ...
          ><span class="s" aria-hidden="true">/</span>
          <span class="cur" aria-current="page">Document Links</span>
        </div>
      </div>
      <button
        class="icon-btn"
      ...
      <header class="page-head">
        ...
        <div class="meta-bar">
          ...
          <div class="meta-item">
            <span class="k">Routing</span>
            <code
              >eglot (LSP imports)<span class="route-arrow">→</span>ffap (local
                ...
                <div class="vs-card ok">
                  ...
                  <div class="vs-list">
                    <div class="vs-row">
                      ...
                      <span class="val"
                        >Works seamlessly with <code>eglot</code> and requires
                    ...
                    <div class="vs-row">
                      <span class="lab">Performance</span>
                      <span class="val"
                        >Zero latency. <code>ffap</code> and
                    ...
                    <div class="vs-row">
                      ...
                      <span class="val"
                        >Works perfectly in air-gapped environments, local
                ...
                <div class="vs-card no">
                  ...
                  <div class="vs-list">
                    ...
                    <div class="vs-row">
                      <span class="lab">Performance</span>
                      <span class="val"
                        >Incurs network round-trips for
                    ...
                    <div class="vs-row">
                      <span class="lab">Offline reliability</span>
                      <span class="val"
                        >Fails or degrades gracefully only if complex fallback
