...
<html lang="en">
  <head>
    ...
    <title>Emacs IDE — Call Hierarchy</title>
    <link
  ...
  <body>
    ...
    <header class="topbar">
      <div class="topbar-left">
        ...
        <div class="crumbs" aria-label="Breadcrumb">
          ...
          <span class="cur" aria-current="page">Call Hierarchy</span>
        </div>
      </div>
      <button
        class="icon-btn"
    ...
    <main class="main" id="main-content">
      <header class="page-head">
        ...
        <div class="parity">
          <b>VS Code Parity</b>
          <span>"Show Call Hierarchy" (incoming/outgoing calls tree view)</span>
        </div>
        <div class="meta-bar">
          <div class="meta-item">
            <span class="k">LSP</span>
            <code>textDocument/prepareCallHierarchy</code>
            <span class="meta-sep" aria-hidden="true">·</span>
            <code>callHierarchy/incomingCalls</code>
            <span class="meta-sep" aria-hidden="true">·</span>
            <code>callHierarchy/outgoingCalls</code>
          </div>
          <div class="meta-item">
            <span class="k">Routing</span>
            <code
              >eglot<span class="route-arrow">→</span
              >eglot-show-call-hierarchy<span class="route-arrow">→</span
              >interactive *eglot-hierarchy* buffer</code
            >
          </div>
        </div>
      </header>
      <article class="acc">
        <button
          class="acc-head open"
          aria-expanded="true"
          aria-controls="call-sect-overview"
        >
          <span class="t">
            <svg
              class="ic"
        ...
        <div class="acc-body open" id="call-sect-overview" role="region">
          <div>
            <div class="acc-inner">
              ...
              <div class="tbl-wrap">
                <table class="tbl">
                  ...
                  <tbody>
                    <tr>
                      <td><kbd>Shift+Alt+H</kbd> opens call hierarchy</td>
                      <td>
                        <kbd>SPC c h</kbd> or <kbd>g c</kbd> invokes
                        <code>eglot-show-call-hierarchy</code>.
                      </td>
                    </tr>
                    <tr>
                      <td>Tree view of incoming calls (callers)</td>
                      <td>
                        Native Eglot hierarchy buffer displays "Incoming Calls"
                        expandable nodes.
                      </td>
                    </tr>
                    <tr>
                      <td>Tree view of outgoing calls (callees)</td>
                      <td>
                        Native Eglot hierarchy buffer displays "Outgoing Calls"
                        expandable nodes.
                      </td>
                    </tr>
                    <tr>
      ...
      <article class="acc">
        <button
          class="acc-head"
          aria-expanded="false"
          aria-controls="call-sect-ecosystem"
        >
          <span class="t">
            <svg
              class="ic"
        ...
        <div class="acc-body" id="call-sect-ecosystem" role="region">
          <div>
            <div class="acc-inner">
              <div class="grid-2">
                <div class="eco-card">
                  ...
                  <p class="eco-desc">
                    ...
                    <code>textDocument/prepareCallHierarchy</code> and
                    subsequent <code>incomingCalls</code>/<code
                      >outgoingCalls</code
                    >
                ...
                <div class="eco-card">
                  ...
                  <p class="eco-desc">
                    ...
                    for node navigation, ensuring that jumping to a
                    caller/callee integrates perfectly with the global
                ...
                <div class="eco-card">
                  ...
                  <p class="eco-desc">
                    Eagerly registers the <kbd>SPC c h</kbd> and
                    <kbd>g c</kbd> leader bindings, ensuring the command is
                ...
                <div class="eco-card">
                  ...
                  <p class="eco-desc">
                    ...
                    <code>consult-eglot-symbols</code>
                    for flat, fuzzy-filtered workspace-wide symbol searches if
                    the tree view becomes too deep.
                  </p>
                </div>
              </div>
            </div>
      ...
      <article class="acc">
        ...
        <div class="acc-body" id="call-sect-stack" role="region">
          <div>
            <div class="acc-inner">
              <div class="grid-2">
                <div class="stack-card">
                  ...
                  <div class="stack-ct">
                    ...
                    <div class="stack-desc">
                      Built-in. Drives the <code>callHierarchy/*</code> protocol
      ...
      <article class="acc">
        <button
          class="acc-head"
          aria-expanded="false"
          aria-controls="call-sect-commands"
        >
          <span class="t">
            <svg
              class="ic"
        ...
        <div class="acc-body" id="call-sect-commands" role="region">
          <div>
            <div class="acc-inner">
              <div class="tbl-wrap">
                <table class="tbl">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        Jumps to the selected caller/callee definition in the
                        source buffer.
                      </td>
                    </tr>
                  </tbody>
      ...
      <article class="acc">
        <button
          class="acc-head"
          aria-expanded="false"
          aria-controls="call-sect-config"
        >
          <span class="t">
            <svg
              class="ic"
        ...
        <div class="acc-body" id="call-sect-config" role="region">
          <div>
            <div class="acc-inner">
              <div class="code-win">
                <div class="code-head">
                  <div style="display: flex; align-items: center">
                    ...
                    <span class="fname">init-call-hierarchy.el</span>
                  </div>
                  <button
                    class="copy"
...
(general-define-key
  ...
  "g T" #'eglot-show-type-hierarchy)</code></pre>
      ...
      <article class="acc">
        ...
        <div class="acc-body" id="call-sect-arch" role="region">
          <div>
            <div class="acc-inner">
                ...
                <div class="vs-card ok">
                  ...
                  <div class="vs-list">
                    ...
                    <div class="vs-row">
                      ...
                      <span class="val"
                        ><code>eglot-show-call-hierarchy</code> is a native
                        command added to Eglot in late 2025.</span
                      >
                    </div>
                    <div class="vs-row">
                      <span class="lab">Performance</span>
                      <span class="val"
                        >Renders directly via Eglot's optimized hierarchy API
                ...
                <div class="vs-card no">
                  ...
                  <div class="vs-list">
                    <div class="vs-row">
                      <span class="lab">Coupling</span>
                      <span class="val"
                        >Third-party <code>eglot-hierarchy</code> is obsolete;
                    ...
                    <div class="vs-row">
                      <span class="lab">Protocol</span>
                      <span class="val"
                        >Requires forbidden <code>lsp-mode</code> ecosystem or
                    ...
                    <div class="vs-row">
                      <span class="lab">Emacs 31 Synergy</span>
                      <span class="val"
                        >External packages duplicate functionality now present
                        in Emacs core.</span
                      >
                    </div>
                    <div class="vs-row">
                      <span class="lab">Performance</span>
                      <span class="val"
                        >Legacy packages introduce unnecessary indirection and
              ...
              <div class="grid-2">
                <div class="enh-card g">
                  ...
                  <p class="enh-desc">
                    As of late 2025, <code>eglot-show-call-hierarchy</code> and
                    <code>eglot-show-type-hierarchy</code> are fully integrated
                    into Eglot, popping up a special buffer showing an
                    interactive tree which represents a hierarchy of sub- and
                    super-calls. This eliminates the need for external packages.
                  </p>
                </div>
                <div class="enh-card p">
                  ...
                  <p class="enh-desc">
                    ...
                    smooth, keyboard-driven expansion and contraction of
                    caller/callee trees without relying on fragile third-party
                    UI overlays.
                  </p>
                </div>
                <div class="enh-card y">
                  ...
                  <p class="enh-desc">
                    Selecting a node in the call hierarchy seamlessly delegates
...
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Emacs IDE — Type Hierarchy</title>
    <link
      href="https://cdn.jsdelivr.net/npm/@fontsource/jetbrains-mono@5.0.18/index.min.css"
      rel="stylesheet"
    />
    ...
    <header class="topbar">
      <div class="topbar-left">
        ...
        <div class="crumbs" aria-label="Breadcrumb">
          ...
          <span>Navigation &amp; Code Jumping</span
          ><span class="s" aria-hidden="true">/</span>
          <span class="cur" aria-current="page">Type Hierarchy</span>
        </div>
      </div>
      <button
        class="icon-btn"
    ...
    <main class="main" id="main-content">
      <header class="page-head">
        ...
        <div class="meta-bar">
          ...
          <div class="meta-item">
            ...
            <code
              >eglot<span class="route-arrow">→</span
              >eglot-show-type-hierarchy<span class="route-arrow">→</span
              >interactive *eglot-hierarchy* buffer</code
            >
          </div>
        </div>
      ...
      <article class="acc">
        <button
          class="acc-head open"
          aria-expanded="true"
          aria-controls="type-sect-overview"
        >
          <span class="t">
            <svg
              class="ic"
      ...
      <article class="acc">
        <button
          class="acc-head"
          aria-expanded="false"
          aria-controls="type-sect-ecosystem"
        >
          <span class="t">
            <svg
              class="ic"
      ...
      <article class="acc">
        <button
          class="acc-head"
          aria-expanded="false"
          aria-controls="type-sect-commands"
        >
          <span class="t">
            <svg
              class="ic"
      ...
      <article class="acc">
        <button
          class="acc-head"
          aria-expanded="false"
          aria-controls="type-sect-config"
        >
          <span class="t">
            <svg
              class="ic"
                ...
                <div class="vs-card ok">
                  ...
                  <div class="vs-list">
                    ...
                    <div class="vs-row">
                      <span class="lab">Emacs 31 Synergy</span>
                      <span class="val"
                        ><code>eglot-show-type-hierarchy</code> is a native
