...
<html lang="en">
  <head>
    ...
    <title>Emacs IDE — Selection Range</title>
    <link
    ...
    <header class="topbar">
      <div class="topbar-left">
        ...
        <div class="crumbs" aria-label="Breadcrumb">
          ...
          <span class="cur" aria-current="page">Selection Range</span>
        </div>
      </div>
      <button
        class="icon-btn"
      ...
      <header class="page-head">
        ...
        <div class="meta-bar">
          ...
          <div class="meta-item">
            ...
            <code
              >treesit<span class="route-arrow">→</span>expreg<span
                class="route-arrow"
                >→</span
              >repeat-mode</code
            >
                ...
                <div class="vs-card ok">
                  ...
                  <div class="vs-list">
                    <div class="vs-row">
                      ...
                      <span class="val"
                        ><b>0ms.</b> Executes via native C-level AST pointer
                        arithmetic.</span
                      >
                    </div>
                    <div class="vs-row">
                      ...
                      <span class="val"
                        ><b>Perfect.</b> Works offline and is independent of
                    ...
                    <div class="vs-row">
                      ...
                      <span class="val"
                        ><code>expreg-restore-point-on-quit</code> guarantees
                ...
                <div class="vs-card no">
                  ...
                  <div class="vs-list">
                    ...
                    <div class="vs-row">
                      <span class="lab">State Preservation</span>
                      <span class="val"
                        >LSP implementations often lose track of the original
...
Filename: linked-editing-range.html
...
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Emacs IDE — Linked Editing Range</title>
    <link
      href="https://cdn.jsdelivr.net/npm/@fontsource/jetbrains-mono@5.0.18/index.min.css"
      rel="stylesheet"
    />
  ...
  <body>
    ...
    <header class="topbar">
      <div class="topbar-left">
        ...
        <div class="crumbs" aria-label="Breadcrumb">
          <span>Docs</span><span class="s" aria-hidden="true">/</span>
          <span>Visual Enhancements / Editing</span
          ><span class="s" aria-hidden="true">/</span>
          <span class="cur" aria-current="page">Linked Editing Range</span>
        </div>
      </div>
      <button
        class="icon-btn"
      ...
      <header class="page-head">
        ...
        <div class="meta-bar">
          <div class="meta-item">
            ...
            <span class="meta-sep" aria-hidden="true">·</span>
            <span style="color: var(--text-dim); font-size: 12px"
              >(Intentionally bypassed)</span
            >
          </div>
          <div class="meta-item">
            <span class="k">Routing</span>
            <code
              >auto-rename-tag<span class="route-arrow">→</span>native Emacs
                ...
                <div class="vs-card ok">
                  ...
                  <div class="vs-list">
                    <div class="vs-row">
                      <span class="lab">Latency</span>
                      <span class="val"
                        ><b>0ms.</b> Executes locally via native Emacs regex/AST
                        parsing.</span
                      >
                    </div>
                    <div class="vs-row">
                    ...
                    <div class="vs-row">
                      ...
                      <span class="val"
                        >Integrates seamlessly with <code>tsx-ts-mode</code> and
                ...
                <div class="vs-card no">
                  ...
                  <div class="vs-list">
                    <div class="vs-row">
                      <span class="lab">Latency</span>
                      <span class="val"
                        ><b>High.</b> Requires a synchronous network round-trip
                    ...
                    <div class="vs-row">
                      <span class="lab">Emacs 31 Synergy</span>
                      <span class="val"
                        >No specific integration with Emacs 31 core
                        enhancements.</span
                      >
                    </div>
                  </div>
