Filename: diagnostics-pull.html
...
<html lang="en">
  <head>
    ...
    <title>Emacs IDE — Diagnostics (Pull Model)</title>
    <link
    ...
    <header class="topbar">
      <div class="topbar-left">
        ...
        <div class="crumbs" aria-label="Breadcrumb">
          ...
          <span class="cur" aria-current="page">Diagnostics (Pull)</span>
        </div>
      </div>
      <button
        class="icon-btn"
      ...
      <header class="page-head">
        ...
        <div class="meta-bar">
          ...
          <div class="meta-item">
            ...
            <code
              >flymake-start<span class="route-arrow">→</span>eglot<span
                class="route-arrow"
                >→</span
              >LSP pull request<span class="route-arrow">→</span>flymake
              aggregation</code
            >
          </div>
        </div>
                ...
                <div class="vs-card ok">
                  ...
                  <div class="vs-list">
                    ...
                    <div class="vs-row">
                      ...
                      <span class="val"
                        >Allows users to disable <code>flymake-mode</code>
                ...
                <div class="vs-card no">
                  ...
                  <div class="vs-list">
                    ...
                    <div class="vs-row">
                      <span class="lab">Flexibility</span>
                      <span class="val"
                        >Tightly couples auto-checking with the LSP client
                        lifecycle.</span
                      >
                    </div>
                  </div>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        reserve <code>consult-flymake-project</code> (<kbd
                          >SPC c E</kbd
    ...
    <header class="topbar">
      <div class="topbar-left">
        ...
        <div class="crumbs" aria-label="Breadcrumb">
          ...
          ><span class="s" aria-hidden="true">/</span>
          <span class="cur" aria-current="page">Moniker</span>
        </div>
      </div>
      <button
        class="icon-btn"
      ...
      <header class="page-head">
        ...
        <div class="meta-bar">
          ...
          <div class="meta-item">
            <span class="k">Routing</span>
            <code
              >eglot<span class="route-arrow">→</span>custom inspection command
              (no native UI)</code
            >
          </div>
        </div>
                ...
                <div class="vs-card ok">
                  ...
                  <div class="vs-list">
                    ...
                    <div class="vs-row">
                      ...
                      <span class="val"
                        >Acknowledges that monikers are for external indexers,
                    ...
                    <div class="vs-row">
                      ...
                      <span class="val"
                        >Zero overhead; the custom function only executes on
                ...
                <div class="vs-card no">
                  ...
                  <div class="vs-list">
                    ...
                    <div class="vs-row">
                      <span class="lab">Architectural honesty</span>
                      <span class="val"
                        >Often bundles heavy, unnecessary UI wrappers for
                    ...
                    <div class="vs-row">
                      <span class="lab">Performance</span>
                      <span class="val"
                        >Background indexing and heavy UI wrappers can cause
