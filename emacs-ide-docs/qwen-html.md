...
<html lang="en">
  <head>
    ...
    <title>Emacs IDE — IntelliSense</title>
    <link
    ...
    <style>
      ...
      * {
      ...
      .route-arrow {
        ...
        margin: 0 6px;
        line-height: 0;
        transform: translateY(-1px); /* Ensure optical centering */
      }
      .meta-sep {
    ...
    <header class="topbar">
      <div class="topbar-left">
        ...
        <div class="crumbs" aria-label="Breadcrumb">
          ...
          <span class="cur" aria-current="page">IntelliSense</span>
        </div>
      </div>
      <button
        class="icon-btn"
    ...
    <main class="main" id="main-content">
      <header class="page-head">
        ...
        <div class="parity">
          <b>VS Code Parity</b>
          <span
            >Autocomplete popup · ghost text · auto-imports · fuzzy
            filtering</span
          >
        </div>
        <div class="meta-bar">
          ...
          <div class="meta-item">
            ...
            <code
              >eglot<span class="route-arrow">→</span>capf<span
                class="route-arrow"
                >→</span
              >cape<span class="route-arrow">→</span>corfu</code
            >
          </div>
        </div>
      </header>
              ...
              <div class="grid-2">
                ...
                <div class="eco-card">
                  <div class="eco-top">
                    <div
                      class="eco-ic"
                      style="background: rgba(224, 175, 104, 0.1); color: var(--yellow);"
                    >
                      <svg
                        viewBox="0 0 24 24"
                        fill="none"
            ...
            <div class="acc-inner">
              <div class="grid-2">
                ...
                <div class="stack-card">
                  <div
                    class="stack-ic"
                    style="background: rgba(255, 158, 100, 0.1); color: var(--orange);"
                  >
                    <svg
                      viewBox="0 0 24 24"
                      fill="none"
...
("&lt;escape&gt;" . corfu-quit)))</code></pre>
          ...
          <div>
            <div class="acc-inner">
                ...
                <div class="vs-card ok">
                  ...
                  <div class="vs-list">
                    <div class="vs-row">
                      ...
                      <span class="val"
                        >Uses native <code>completion-at-point</code> APIs and
                        child-frames.</span
                      >
                    </div>
                    <div class="vs-row">
                      ...
                      <span class="val"
                        >Exponentially lighter; zero main-thread blocking during
                        typing.</span
                      >
                    </div>
                    <div class="vs-row">
                      ...
                      <span class="val"
                        >Integrates with <code>orderless</code> for out-of-order
                        fuzzy matching.</span
                      >
                    </div>
                    <div class="vs-row">
                      ...
                      <span class="val"
                        >Leverages native TTY child-frames and PGTK Wayland
                        fixes.</span
                      >
                    </div>
                  </div>
                ...
                <div class="vs-card no">
                  ...
                  <div class="vs-list">
                    <div class="vs-row">
                      <span class="lab">Architecture</span>
                      <span class="val"
                        >Custom overlay engine and heavy workspace
                        management.</span
                      >
                    </div>
                    <div class="vs-row">
                      <span class="lab">Performance</span>
                      <span class="val"
                        >Prone to micro-stutters and "stutter-and-vanish" popup
                        bugs.</span
                      >
                    </div>
                    <div class="vs-row">
                      <span class="lab">Filtering</span>
                      <span class="val"
                        >Requires <code>company-flx</code>; struggles with
                    ...
                    <div class="vs-row">
                      ...
                      <span class="val"
                        >Breaks the <code>eglot</code>-only stack mandate.</span
                      >
                    </div>
                  </div>
                </div>
              ...
              <div class="grid-2">
                ...
                <div
                  class="enh-card y"
                  style="grid-column: 1 / -1; max-width: 50%; justify-self: center;"
                >
      ...
      <section id="hover-info" class="feature-page">
        <header class="page-head">
          <div class="title-row">
            <h1>Hover Info</h1>
            <span class="status" role="status">Working</span>
        ...
        <article class="acc">
          <button
            class="acc-head open"
            aria-expanded="true"
            aria-controls="hover-sect-overview"
          >
            <span class="t">
              <svg
                class="ic"
                  ...
                  <table class="tbl">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <code>eldoc-help-at-pt t</code> surfaces info on
                          cursor movement
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          <kbd>K</kbd> bound to <code>eldoc</code> in Evil
                          normal state
                        </td>
                      </tr>
                      <tr>
        ...
        <article class="acc">
          <button
            class="acc-head"
            aria-expanded="false"
            aria-controls="hover-sect-ecosystem"
          >
            <span class="t">
              <svg
                class="ic"
                ...
                <div class="grid-2">
                  <div class="eco-card">
                    ...
                    <p class="eco-desc">
                      ...
                      <code>eldoc-documentation-functions</code> when a buffer
                      is LSP-managed.
                    </p>
                  </div>
                  <div class="eco-card">
                    ...
                    <p class="eco-desc">
                      Serves as the unified router — aggregating LSP hover,
                      Elisp docstrings, and <code>help-at-point</code> into a
                      single echo-area / ephemeral-buffer pipeline.
                    </p>
                  </div>
                  <div class="eco-card">
                    <div class="eco-top">
        ...
        <article class="acc">
          <button
            class="acc-head"
            aria-expanded="false"
            aria-controls="hover-sect-stack"
          >
            <span class="t">
              <svg
                class="ic"
                ...
                <div class="grid-2">
                  <div class="stack-card">
                    ...
                    <div class="stack-ct">
                      ...
                      <div class="stack-desc">
                        ...
                        returns Markdown payloads natively.
                      </div>
                    </div>
                  </div>
                  <div class="stack-card">
                  ...
                  <div class="stack-card">
                    ...
                    <div class="stack-ct">
                      ...
                      <div class="stack-desc">
                        Built-in. Provides rich tree-sitter markdown
                        fontification inside the ephemeral buffer.
                      </div>
                    </div>
                  </div>
                  <div class="stack-card">
        ...
        <article class="acc">
          <button
            class="acc-head"
            aria-expanded="false"
            aria-controls="hover-sect-commands"
          >
            <span class="t">
              <svg
                class="ic"
                  ...
                  <table class="tbl">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          Shows/hides doc popup for selected completion
                          candidate.
                        </td>
                      </tr>
                      <tr>
        ...
        <article class="acc">
          <button
            class="acc-head"
            aria-expanded="false"
            aria-controls="hover-sect-config"
          >
            <span class="t">
              <svg
                class="ic"
              ...
              <div class="acc-inner">
                  ...
                  <div class="vs-card ok">
                    ...
                    <div class="vs-list">
                      ...
                      <div class="vs-row">
                        <span class="lab">Protocol</span
                        ><span class="val"
                          >Honors the <code>eglot</code>-only stack
                          mandate.</span
                        >
                      </div>
                      <div class="vs-row">
                        <span class="lab">Integration</span
                        ><span class="val"
                          >Native ephemeral buffer with
                      ...
                      <div class="vs-row">
                        <span class="lab">Performance</span
                        ><span class="val"
                          >Zero additional packages, echo-area fast path.</span
                        >
                      </div>
                    </div>
                  </div>
                  <div class="vs-card no">
                    ...
                    <div class="vs-list">
                      <div class="vs-row">
                        <span class="lab">Coupling</span
                        ><span class="val"
                          >Hard-bound to <code>lsp-mode</code> or requires
                      ...
                      <div class="vs-row">
                        <span class="lab">Integration</span
                        ><span class="val"
                          >No integration with Emacs native eldoc
                          enhancements.</span
                        >
                      </div>
                      <div class="vs-row">
                        <span class="lab">Performance</span
                        ><span class="val"
                          >Child-frame latency on every hover / rendering
                          overhead.</span
                        >
                      </div>
                    </div>
                ...
                <div class="grid-2">
                  ...
                  <div class="enh-card g">
                    ...
                    <p class="enh-desc">
                      Unlike child-frame-based solutions
                      (<code>eldoc-box</code>, <code>lsp-ui-doc</code>), the
                      ephemeral buffer approach degrades gracefully to TTY
                      frames, ensuring documentation is accessible over SSH.
                    </p>
                  </div>
                </div>
              </div>
