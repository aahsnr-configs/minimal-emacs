...
<html lang="en">
  <head>
    ...
    <title>Emacs IDE — Code Actions</title>
    <link
    ...
    <header class="topbar">
      <div class="topbar-left">
        ...
        <div class="crumbs" aria-label="Breadcrumb">
          ...
          <span class="cur" aria-current="page">Code Actions</span>
        </div>
      </div>
      <button
        class="icon-btn"
      ...
      <header class="page-head">
        ...
        <div class="meta-bar">
          ...
          <div class="meta-item">
            ...
            <code
              >eglot<span class="route-arrow">→</span>eglot-code-actions<span
                class="route-arrow"
                >→</span
                ...
                <div class="vs-card ok">
                  ...
                  <div class="vs-list">
                    ...
                    <div class="vs-row">
                      ...
                      <span class="val"
                        >Native <code>completing-read</code> menu + Emacs 31
...
Filename: document-formatting.html
...
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Emacs IDE — Document Formatting</title>
    <link
      href="https://cdn.jsdelivr.net/npm/@fontsource/jetbrains-mono@5.0.18/index.min.css"
      rel="stylesheet"
    />
    ...
    <header class="topbar">
      <div class="topbar-left">
        ...
        <div class="crumbs" aria-label="Breadcrumb">
          ...
          ><span class="s" aria-hidden="true">/</span>
          <span class="cur" aria-current="page">Document Formatting</span>
        </div>
      </div>
      <button
        class="icon-btn"
        ...
        <div class="meta-bar">
          <div class="meta-item">
            ...
            <span style="color: var(--text-dim); font-size: 12px"
              >(bypassed for whole-file ops)</span
            >
          </div>
          <div class="meta-item">
            <span class="k">Routing</span>
            <code
              >apheleia (async CLI diff) OR eglot<span class="route-arrow"
                >→</span
              >eglot-format-buffer</code
            >
          </div>
        </div>
      </header>
                ...
                <div class="vs-card ok">
                  ...
                  <div class="vs-list">
                    <div class="vs-row">
                      ...
                      <span class="val"
                        ><b>Zero.</b> Runs in a background process; UI remains
                    ...
                    <div class="vs-row">
                      ...
                      <span class="val"
                        ><b>Perfect.</b> Computes a diff and applies it,
                    ...
                    <div class="vs-row">
                      <span class="lab">Protocol</span>
                      <span class="val"
                        >Bypasses LSP for formatting, but honors the
                    ...
                    <div class="vs-row">
                      ...
                      <span class="val"
                        >Uses the <i>exact same</i> CLI tools the LSP server
                ...
                <div class="vs-card no">
                  ...
                  <div class="vs-list">
                    <div class="vs-row">
                      <span class="lab">Thread Blocking</span>
                      <span class="val"
                        ><b>High.</b> Synchronous; blocks the main thread until
                    ...
                    <div class="vs-row">
                      <span class="lab">Cursor/Undo</span>
                      <span class="val"
                        ><b>Poor.</b> Often resets cursor to the top of the
                    ...
                    <div class="vs-row">
                      <span class="lab">Formatter Parity</span>
                      <span class="val"
                        >Relies entirely on the LSP server's internal formatting
                        logic.</span
                      >
                    </div>
                  </div>
