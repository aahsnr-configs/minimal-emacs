Filename: go-to-definition.html
...
<html lang="en">
  <head>
    ...
    <title>Emacs IDE — Go to Definition</title>
    <link
    ...
    <header class="topbar">
      <div class="topbar-left">
        ...
        <div class="crumbs" aria-label="Breadcrumb">
          ...
          <span class="cur" aria-current="page">Go to Definition</span>
        </div>
      </div>
      <button
        class="icon-btn"
...
(ar/global-leader
  ...
  "c p d" '(peek-xref-definition :wk "Peek definition"))</code></pre>
              </div>
            </div>
          </div>
        </div>
                ...
                <div class="vs-card ok">
                  ...
                  <div class="vs-list">
                    ...
                    <div class="vs-row">
                      ...
                      <span class="val"
                        >Native Emacs 31 <code>xref-mouse-mode</code> (zero
                        dependencies).</span
                      >
                    </div>
                  </div>
                ...
                <div class="vs-card no">
                  ...
                  <div class="vs-list">
                    ...
                    <div class="vs-row">
                      <span class="lab">Mouse</span>
                      <span class="val"
                        >Requires custom mouse-click advice.</span
                      >
                    </div>
                  </div>
                </div>
...
Filename: go-to-declaration.html
...
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Emacs IDE — Go to Declaration</title>
    <link
      href="https://cdn.jsdelivr.net/npm/@fontsource/jetbrains-mono@5.0.18/index.min.css"
      rel="stylesheet"
    />
    ...
    <header class="topbar">
      <div class="topbar-left">
        ...
        <div class="crumbs" aria-label="Breadcrumb">
          ...
          <span>Navigation &amp; Code Jumping</span
          ><span class="s" aria-hidden="true">/</span>
          <span class="cur" aria-current="page">Go to Declaration</span>
        </div>
      </div>
      <button
        class="icon-btn"
        ...
        <div class="meta-bar">
          ...
          <div class="meta-item">
            ...
            <code
              ...
              >eglot-find-declaration<span class="route-arrow">→</span>xref
              framework</code
            >
          </div>
        </div>
...
(ar/global-leader
  ...
  "c g t" '(eglot-find-typeDefinition :wk "Type Definition"))</code></pre>
              </div>
            </div>
          </div>
        </div>
