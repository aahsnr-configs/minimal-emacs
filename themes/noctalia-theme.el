...
(let* ((bg "#131316")
      ...
      (outline-color "#919099")
      (outline-variant "#46464f")
      (primary "#c0c2f8")
      (primary-container "#3f4370")
      (secondary "#c5c4dc")
      ...
      (tertiary "#efb5dd")
      (tertiary-container "#633859")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#efb5dd")
      (on-success "#4a2242")
      (success-container "#633859")
      (on-success-container "#ffd7f1")
      ;; Map fixed colors to regular colors
      (primary-fixed "#c0c2f8")
      (primary-fixed-dim "#3f4370")
      (secondary-fixed "#c5c4dc")
      (secondary-fixed-dim "#444559")
      (tertiary-fixed "#efb5dd")
      (tertiary-fixed-dim "#633859")
      (on-primary-fixed "#292c58")
      (on-primary-fixed-variant "#e0e0ff")
      (on-secondary-fixed "#2e2f41")
      (on-secondary-fixed-variant "#e1e0f9")
      (on-tertiary-fixed "#4a2242")
      (on-tertiary-fixed-variant "#ffd7f1")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#e5e1e6")
      (inverse-primary "#c0c2f8")
      (inverse-surface "#131316")
