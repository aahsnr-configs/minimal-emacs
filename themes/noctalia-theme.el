...
(let* ((bg "#131316")
      ...
      (success "#e8b9d5")
      (on-success "#46263b")
      (success-container "#5e3c53")
      (on-success-container "#ffd8ee")
      ;; Map fixed colors to regular colors
      (primary-fixed "#bec2ff")
      (primary-fixed-dim "#373e90")
      (secondary-fixed "#c5c4dd")
      (secondary-fixed-dim "#444559")
      (tertiary-fixed "#e8b9d5")
      (tertiary-fixed-dim "#5e3c53")
      (on-primary-fixed "#1f2578")
      (on-primary-fixed-variant "#e0e0ff")
      (on-secondary-fixed "#2e2f42")
      (on-secondary-fixed-variant "#e1e0f9")
      (on-tertiary-fixed "#46263b")
      (on-tertiary-fixed-variant "#ffd8ee")
