...
* DONE ore Emacs Configuration
- State "DONE"       from "TODO"       [2026-01-27 Tue 05:07]
...
** DONE Load Path
- State "DONE"       from "TODO"       [2026-01-27 Tue 05:06]
#+begin_src emacs-lisp
...
** DONE Automatically reload files was modified by external program
#+begin_src emacs-lisp
...
** DONE Highlight brackets according to their depth
#+begin_src emacs-lisp
...
** DONE Parenthesis Matching & Context
#+begin_src emacs-lisp
(use-package paren
  :straight (:type built-in)
...
** DONE Highlight TODO and similar keywords
#+begin_src emacs-lisp
(use-package hl-todo
  :defer t
...
** DONE Colorize color names in buffers
#+begin_src emacs-lisp
...
** DONE Direnv
- State "DONE"       from "TODO"       [2026-01-27 Tue 04:26]
#+begin_src emacs-lisp
(use-package envrc
...
** DONE Magit Todos: Track TODOs in Commits
#+begin_src emacs-lisp
...
** DONE File Management Extensions
#+begin_src emacs-lisp
(use-package dired-x
  :straight (:type built-in)
...
- State "DONE"       from              [2026-01-27 Tue 04:25]
** Project Awareness
#+begin_src emacs-lisp
...
(use-package tex
  ...
  (setq TeX-engine 'luatex
        ...
        ;; TODO: Determine if this options is needed
        TeX-check-TeX nil

        ;; clean intermediate files without asking
        TeX-clean-confirm nil

        ;; TODO: Decide on the best option for this variable based on the page 21
...
* DONE Window
- State "DONE"       from "TODO"       [2026-01-27 Tue 04:25]
** Winner
#+begin_src emacs-lisp
(use-package winner
  :straight (:type built-in)
